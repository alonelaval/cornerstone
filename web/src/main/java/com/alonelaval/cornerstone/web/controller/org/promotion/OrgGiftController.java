...
import com.alonelaval.cornerstone.entity.model.OrgGiftModel;
 ...
 **/
@Controller
@RequestMapping("org/gift")
public class OrgGiftController extends AbstractController {

    @Autowired
    OrgGiftService orgGiftService;

    @PostMapping("add")
    public Object add(@Validated OrgGiftModel orgGiftModel) throws Exception {
       return  super.addBasic(orgGiftModel);
    }

    @PostMapping("update")
    public Object update(@Validated OrgGiftModel orgGiftModel,@NotNull(message = "ID不能为空！") Integer id) throws Exception {
        return  super.updateBasic(orgGiftModel,id);
    }

    @PostMapping("list")
    public Object list(OrgGiftModel model, Page<OrgGift> page) throws Exception {
