...
public class AreaController extends AbstractController {
    ...
    @PostMapping("add")
    public Object add(@Validated AreaModel areaModel) throws Exception {
       return  super.addBasic(areaModel);
    }

    @PostMapping("update")
    public Object update(@Validated AreaModel areaModel,@NotNull(message = "ID不能为空！") Integer id) throws Exception {
        return  super.updateBasic(areaModel,id);
    }

    @PostMapping("list")
    public Object list(AreaModel model, Page<Area> page) throws Exception {
